...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
			    ...
			    <li id="header3">
			      ...
			      <ul>
			        <li><a href="#" id="logoutBtn">LOGOUT</a></li>
			      	...
			      	<li><a href="#" id="openManagementForm">MANAGEMENT</a></li>
			      </ul>
			    </li>
		    </c:when>
		    <c:when test="${loginMember == null }">
	...
	<div id="management-form" class="dialog-form" title="전체 회원 목록 폼">
		<table class="table">
	...
	<script>
		...
		$("#openManagementForm").on("click", function() {
			$("#management-form").dialog("open");
		});
