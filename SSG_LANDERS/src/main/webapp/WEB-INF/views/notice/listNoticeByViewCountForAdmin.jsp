...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	    <div id="listContainer">
 			<a href="<c:url value='/notice/listNoticeForAdmin.do'/>" id="listByRecentButton" class="detailBtns">최신순</a>
			...
			<form id="pageForm" name="pageForm" action="<c:url value='/notice/listNoticeByViewCountForAdmin.do'/>" method="post">
    ...
    <script>
        ...
        deleteButton.on("click", function() {
      		if (confirm("게시물을 삭제하시겠습니까 ?")) {
    			...
    			.then((json) => {
    				alert(json.message);
    				if (json.status) location.href = "<c:url value='/notice/listNoticeByViewCountForAdmin.do'/>";
    			});
      		}
      	});
