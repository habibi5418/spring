...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	    <div id="listContainer">
 			<a href="listBoardByViewCount.do" id="listByViewCountButton" class="detailBtns">조회순</a>
					...
					<c:when test="${loginMember != null && loginMember.isAdmin('admin') }">
						...
						<c:forEach var="board" items="${boardList }">
							<tr>
								...
								<td><a href='detailBoard.do?boardid=${board.getBoardid() }&order=recent'>${board.title }</a></td>
